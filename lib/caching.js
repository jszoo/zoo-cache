...
caching.prototype = {
    ...
    set: function(key, value, expire, notify) {
        ...
        this.sto().events.emit('set', { region: this.region, key: key, value: value });
    ...
    remove: function(key, action) {
        ...
        // 3 steps
        this._cachedAll = null;
        this.sto().events.emit('remove', { region: this.region, key: key });
    ...
    clear: function() {
        // 3 steps
        this._cachedAll = null;
        this.sto().events.emit('clear', { region: this.region });
